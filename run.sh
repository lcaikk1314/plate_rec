...
# Detect vehicles
python3.5 vehicle-detection.py $1 $2

# Detect license plates
python3.5 license-plate-detection.py $2 data/lp-detector/wpod-net.h5

# OCR
python3.5 license-plate-ocr.py $2

# Draw output and generate list
python3.5 gen-outputs.py $1 $2 > $3
